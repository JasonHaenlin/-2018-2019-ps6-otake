exports.seed = (knex) => {
  ...
  return knex('exchange_university').del()
    .then(() => {
      // Inserts seed entries
      return knex('exchange_university').insert([
        {
          id: 0,
          ...
          presentation_text: 'Caltech is a world-renowned science and engineering institute that marshals some of the world\'s ' +
            'brightest minds and most innovative tools to address fundamental scientific questions and pressing societal challenges.' +
            ' The Institute manages JPL for NASA, sending probes to explore the planets of our solar system and quantify changes on ' +
            'our home planet. Caltech also owns and operates large-scale research facilities such as the Seismological Laboratory ' +
            'and a global network of astronomical observatories, including the Palomar and W. M. Keck Observatories; and cofounded ' +
            'and comanages LIGO. Caltech is an independent, privately supported institution with a 124-acre campus located in ' +
            'Pasadena, California.',
          admission_text: 'About 230 new freshmen and 10 to 15 new transfer students join Caltech each fall. Each new student is' +
            ' welcomed into a close-knit, collaborative community of nearly 1,000 undergraduate scholars who have demonstrated the' +
            ' highest level of academic excellence and share a strong interest in science, engineering, and technology.',
          student_life_text: 'Caltech is a small, collaborative community, where faculty, postdoctoral scholars, students, and staff' +
            ' from diverse backgrounds, cultures, and experiences live, work, and engage with one another. Together, they remain ' +
            'committed to setting the example of what its intertwined missions of research and education can accomplish. Caltech is' +
            ' an integral part of Pasadena. Together with JPL, we are the city’s largest employer and a source of programs that ' +
            'benefit our neighbors: teachers, businesses, families, cultural centers, and government. To stay up-to-date on ' +
            'upcoming events and the latest community news, visit Caltech Today or subscribe to Caltech Matters.',
