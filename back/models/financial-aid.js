...
module.exports = new BaseModel('financial_aid', t => {
  t.string('name').primary();
  t.string('description', 2000);
  t.string('conditionsToApply', 2000);
  t.string('termsOfPayment', 2000);
  t.string('procedure', 2000);
  t.string('cumul', 2000);
},
[
  {
    ...
    conditionsToApply: '<p><strong><a href="https://www.generation-erasmus.fr/sejour-bourse-erasmus-etudiant/"' +
        ...
        '<ul><li>dans un <b>pays étranger européen</b></li>' +
        '<li>auprès d\'un<b> établissement de l\'enseignement supérieur</b></li>' +
        '<li>dans le cadre d\'un <strong>échange inter-établissements</strong></li></ul></p>',
  ...
  },
  {
    ...
    conditionsToApply: '<p>L\'aide à la mobilité internationale(400€ / mois en 2018 / 2019) peut vous être attribuée si vous' +
        'remplissez les conditions suivantes : </p><ul>' +
    ...
    termsOfPayment: '<p>L\'aide vous sera accordée en fonction de la durée de votre séjour et de certaines spécificités ' +
        'telles que l\'éloignement du pays d\'accueil, le coût de la vie du pays choisi.<ul>' +
        '<li>L\'aide à la mobilité internationale est <b>cumulable avec une aide au mérite</b></li>' +
        '<li><b>Vous conservez votre bourse sur critères sociaux</b></li></ul>&nbsp;' +
  ...
  },
  {
    ...
    description: '<p>Programme régional d’aide à la mobilité étudiante - ' +
        ...
        '<strong>PRAME enseignement supérieur</strong></a> - BOURSES D’ETUDES ET DE STAGE</p>',
    conditionsToApply: '<strong>Bénéficiaires</strong><ul>' +
        ...
        '<li>Pays du monde, hormis la France (territoires métropolitain et d’Outre-mer) et Monaco.</li></ul>',
    termsOfPayment: '<p>Etudiant effectuant un séjour d\'études sur un campus de son établissement situé sur un territoire ' +
        ...
        'Alpes Côte d\'Azur ;' +
        'Bourse forfaitaire de 600 € pour les étudiants domiciliés fiscalement en Provence Alpes Côte d\'Azur.' +
        '<ul><li>Etudiant effectuant un stage ou un séjour d\'études (hors campus) à l\'étranger :</p>' +
        ...
        'lequel la Région entretient des relations de coopération*.</li></ul>' +
